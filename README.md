...
- [ ] Run `npm run dev`. The web page automatically opens because we're running `webpack-dev-server --open`. We should get a 404 error for the route `/build/bundle.js`.
